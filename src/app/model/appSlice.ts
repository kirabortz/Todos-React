...
const slice = createAppSlice({
  ...
  reducers: creators => {
    return {
      ...
      isInitialized: creators.reducer(
        (state, action: PayloadAction<{ isInitialized: boolean }>) => {
          state.isInitialized = action.payload.isInitialized
        }
      ),
      changeBlockDragMode: creators.reducer(
        (state, action: PayloadAction<{ isBlockDragMode: boolean }>) => {
...
export const { isInitialized, changeBlockDragMode, setAppError, setAppStatus } = slice.actions
export const appActions = { isInitialized, changeBlockDragMode, setAppError, setAppStatus }
