...
const slice = createAppSlice({
  ...
  reducers: creators => {
    ...
    return {
      ...
      login: createAThunk<{ isLoggedIn: true }, LoginProps>(
      ...
      initializeApp: createAThunk<Promise<unknown>, undefined>(
        async (_, { dispatch, rejectWithValue }) => {
          const res = await AuthApi.me()
...
export const { initializeApp, getSecurityApi, getSecurityUrl, getAuth, login, logout, isLoggin } =
  slice.actions
