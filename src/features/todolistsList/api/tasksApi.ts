...
import { TaskProps, TasksResponseProps, UpdateTaskModelProps } from "features/todolistsList/ui/tasks/tasks.types"
...
export const TasksApi = {
  ...
  dragDropTask(todolistId: string, taskId: string, endId: string) {
    return instance.put<ResponseProps<{ item: TaskProps }>>(`todo-lists/${todolistId}/tasks/${taskId}/reorder`, {
      putAfterItemId: endId,
    })
  },
}
